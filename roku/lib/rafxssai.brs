...
function RAFX_getPublicaHLSPlugin(params as object) as object
    ...
    impl.onMetadata = function(msg as object) as void
        m.streamManager.onMetadata(msg, m.wrpdPlayer.sgnode)
    end function
    ...
    strmMgr.onMetadata = function(msg as object, sgnode as object) as void
        ...
        if invalid = ext_x_marker then return
        ...
        if m.history[xobj.id] <> invalid then return
        m.history[xobj.id] = true
        ...
        if "PodBegin" = xobj.xtype
        ...
        else if "PodEnd" = xobj.xtype
            m.sdk.eventCallbacks.doCall(m.sdk.AdEvent.POD_END, {
                event: m.sdk.AdEvent.POD_END
                position: position
                pod: m.pod
            })
            m.pod = invalid
            ...
            m.sdk.eventCallbacks.doCall(m.sdk.AdEvent.IMPRESSION, {
                ...
                position: position
                pod: m.pod
                ad: m.pod.ads[xobj.adindex]
            })
        else if "AdEnd" = xobj.xtype
            m.sdk.eventCallbacks.doCall(m.sdk.AdEvent.COMPLETE, {
                event: m.sdk.AdEvent.COMPLETE
                position: position
                pod: m.pod
                ad: m.pod.ads[xobj.adindex]
            })
        else if "FirstQuartile" = xobj.xtype
            m.sdk.eventCallbacks.doCall(m.sdk.AdEvent.FIRST_QUARTILE, {
                event: m.sdk.AdEvent.FIRST_QUARTILE
                position: position
                pod: m.pod
                ad: m.pod.ads[xobj.adindex]
            })
        else if "Midpoint" = xobj.xtype
            m.sdk.eventCallbacks.doCall(m.sdk.AdEvent.MIDPOINT, {
                event: m.sdk.AdEvent.MIDPOINT
                position: position
                pod: m.pod
                ad: m.pod.ads[xobj.adindex]
            })
        else if "ThirdQuartile" = xobj.xtype
            m.sdk.eventCallbacks.doCall(m.sdk.AdEvent.THIRD_QUARTILE, {
                event: m.sdk.AdEvent.THIRD_QUARTILE
                position: position
                pod: m.pod
                ad: m.pod.ads[xobj.adindex]
            })
    ...
    strmMgr.parseXMarker = function(ext_x_marker as string) as object
        xobj = {
            ...
            duration: val(m.extract(ext_x_marker, m.rgx_duration, "0"))
...
function RAFX_SSAI(params as object) as object
    if invalid <> params and invalid <> params["name"]
        p = RAFX_getPublicaHLSPlugin(params)'
        p["__version__"] = "0.0.1"
